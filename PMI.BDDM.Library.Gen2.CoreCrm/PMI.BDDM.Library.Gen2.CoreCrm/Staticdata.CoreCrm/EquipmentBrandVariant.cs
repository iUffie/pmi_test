...
{
    public class EquipmentBrandVariant : PMI.BDDM.Staticdata.EquipmentBrandVariant
    {
        ...
        [BDDMPropertyInfo("Description", IsRequired = false, IsSecured = false)]
        public PrimitiveString Description { get; set; }
